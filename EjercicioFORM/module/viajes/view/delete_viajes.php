<div id="contenido">
    <form autocomplete="on" method="post" name="delete_viaje" id="delete_viaje" action="index.php?page=controller_viajes&op=delete&id=<?php echo $_GET['id']; ?>">
        <table border='0'>
            <tr>
                <td align="center"  colspan="2"><h3>¿Seguro que quiere borrar el viaje '<?php echo $_GET['id']; ?>'?</h3></td>
