<form method="post" name="formusers" id="formusers">
		...
		<div class="boxes">
			<label>Sexo:</label>
			<input name="sexo" id="sexo" type="radio" <?php if (isset($sexo) && $sexo=="Hombre" )?> value="Hombre" checked>Hombre
			<input name="sexo" id="sexo" type="radio" <?php if (isset($sexo) && $sexo=="Mujer")?> value="Mujer">Mujer
			<input name="sexo" id="sexo" type="radio" <?php if (isset($sexo) && $sexo=="Otro")?> value="Otro">Otro
		</div>
		<div class="boxes">
